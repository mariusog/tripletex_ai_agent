...
class TaskRouter:
    ...
    async def solve(self, request: SolveRequest) -> SolveResponse:
        ...
        try:
            ...
            params = _strip_placeholder_values(classification.params)
